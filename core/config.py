...
def initialize_fonts():
    ...
    FONT_NORMAL = ctk.CTkFont(family=UI_FONT_FAMILY, size=20)
    FONT_BOLD = ctk.CTkFont(family=UI_FONT_FAMILY, size=18, weight="bold")
    FONT_TITLE = ctk.CTkFont(family=UI_FONT_FAMILY, size=30, weight="bold")
    FONT_SIDEBAR = ctk.CTkFont(family=UI_FONT_FAMILY, size=20)
